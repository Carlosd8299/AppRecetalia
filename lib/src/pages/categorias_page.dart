...
import 'package:receipt_app/src/widgets/app_bar_categorias.dart';
import 'package:receipt_app/src/widgets/slider_home.dart';
import 'package:receipt_app/src/widgets/swiperrecetas_categoria.dart';
...
List<Receta> recetasPopulares = [
  ...
  Receta(
      ...
      "10 min",
      ingredientes2,
      lipsum.createSentence(numSentences: 2, sentenceLength: 10),
      true,
      lipsum.createParagraph(numParagraphs: 5, numSentences: 1),
      4.0,
      c1),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          appBarCategorias(c.getName()),
          SliverList(
              delegate: SliverChildListDelegate([
            SwiperPublicidad(swiperInicio),
            Padding(
              padding: const EdgeInsets.fromLTRB(20.0, 20, 20, 10),
              child: titles3("Mejor valoradas", context),
            ),
          ])),
          SliverList(
              delegate: SliverChildListDelegate([
            SwiperRecetaCategoria(recetasPopulares),
            Padding(
              padding: const EdgeInsets.fromLTRB(20.0, 20, 20, 10),
              child: titles3("Recomendadas para ti", context),
            ),
          ])),
          SliverList(
              delegate: SliverChildListDelegate([
